...
class UpdateTransaction(object):
    ...
    def __init__(self, id=None, account_id=None, date=None, amount=None, payee_id=None, payee_name=None, category_id=None, memo=None, cleared=None, approved=None, flag_color=None, import_id=None):  # noqa: E501
