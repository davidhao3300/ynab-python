...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ynab.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the ynab.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ynab.Configuration(
        signing_info = ynab.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
